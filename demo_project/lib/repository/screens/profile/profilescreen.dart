import 'package:demo_project/repository/screens/bottomnav/bottomnavigation.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Theme.of(context).brightness==Brightness.dark? UiHelper.CustomImage(imgurl: "darkprofile.png"):UiHelper.CustomImage(imgurl: "lightprofile.png"),
            SizedBox(height: 30,),
            ...
            SizedBox(height: 10,),
            UiHelper.CustomTextField(controller: lastnameController, text: "Last Name(Required)", textinputtype: TextInputType.name, context: context,icondata: CupertinoIcons.person_2)
          ],
        ),
      ),
